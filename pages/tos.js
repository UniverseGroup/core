...
export async function getServerSideProps(ctx) {
    ...
    const url1 = 'https://raw.githubusercontent.com/UniverseGroup/terms/master/tos.md'
  ...
  const tos = ({...data}) => {
      ...
      return (
        <div className={styles.container}>
            ...
            <HeadTag title='Tos' img={process.env.NORMAL_IMG} description='다양한 봇과 서버가 모여 만들어진 공간, Universe
    ' url={process.env.BASE_URL+'tos'}/>
